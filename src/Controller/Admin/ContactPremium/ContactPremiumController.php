...
{
    #[Route('/contact-premium', name: 'app_admin_contact_premium_index', methods: ['GET'])]
    ...
    #[Route('/contact-premium/delete/{id<\d+>}', name: 'app_admin_contact_premium_delete', methods: ['POST'])]
